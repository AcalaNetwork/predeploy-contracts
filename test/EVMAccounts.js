...
const { hexToU8a, u8aConcat, stringToU8a, u8aToHex } = require('@polkadot/util');

const testPairs = createTestPairs();
const EVMAccountsABI = require('../artifacts/contracts/evm-accounts/EVMAccounts.sol/EVMAccounts.json').abi;
...
describe('EVM Accounts', () => {
  ...
  beforeEach(async function () {
    ...
    evmAccountsPredeployed = new Contract(EVM_ACCOUNTS, EVMAccountsABI, deployer);
  });
  ...
  it('evm accounts in solidity works', async () => {
    ...
    // mapped revert
    await expect(evmAccountsPredeployed.claimDefaultEvmAddress(alicePublicKey)).to.be.revertedWith('AccountIdHasMapped');
